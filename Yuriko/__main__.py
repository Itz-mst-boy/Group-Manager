...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ", url="http://t.me/groupcontrollertgbot?startgroup=true"),
    ],
]
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Than send` `/admincache@groupcontrollertgbot` `in that chat to refresh admin list in My database.`\n"
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, ᴍᴜᴋʜᴜsʜɪ Robot now ready to manage your group.`"
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, MukhushiRobot now ready to manage your group.`"
            f"\n\n*Admin Tools*"
            f"\n✗ `Basic Admin tools help you to protect and powerup your group.`"
            f"\n✗ `You can ban members, Kick members, Promote someone as admin through commands of bot.`"
            f"\n\n*Welcome*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="t.me/worldwide_friend_zone"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴍᴜᴋᴇsʜ", url="t.me/itz_mst_boy"),
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="t.me/mr_sukkun"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_basichelp"),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5142140533 and DONATION_LINK:
            update.effective_message.reply_text(
