    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Mukhushi Robot Chatbot Disabled By {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Mukhushi Robot Chatbot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
__help__ = """
✗ `Chatbot utilizes the` *YURIKO* `api which allows Mukhushi to talk and provide a more interactive group chat experience.`
